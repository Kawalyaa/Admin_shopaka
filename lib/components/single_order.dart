...
class SingleOrder extends StatelessWidget {
        ...
        child: ListTile(
          ...
          leading: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              _orderRichText(firstInfo: firstInfo2, secondInfo: secondInfo2)
            ],
          ),
          trailing: ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushNamed(
                  ...
                  arguments: OrderDetailsScreen(model: model),
                );
              },
              child: Text('Details')),
        ),
  ...
  _orderRichText({String firstInfo, String secondInfo, String deliveryMethod}) {
    return Padding(
        ...
        text: TextSpan(
            ...
            children: [
              TextSpan(
                text: secondInfo,
                style: TextStyle(
                  color: deliveryMethod == 'express' ? kColorRed : Colors.black54,

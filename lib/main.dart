...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    providers: [
      StreamProvider<List<ProductModel>>(create: (_)=>ProductService().getAllProducts(), initialData: []),
      StreamProvider<List<UserModel>>(create: (_)=>UserServices().getUsers(), initialData: [])
    ],
        ...
        routes: {ProductsScreen.id:(context)=>ProductsScreen()},
